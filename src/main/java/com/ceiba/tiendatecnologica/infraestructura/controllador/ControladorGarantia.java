...
public class ControladorGarantia {
	...
	public GarantiaExtendida generar(@PathVariable(name = "idProducto") String codigoProducto,@PathVariable(name = "nombreCliente") String nombreCliente) {
		return this.manejadorGenerarGarantia.ejecutar(codigoProducto,nombreCliente);
	}
